...
$(function(){
    ...
    CT.search = function() {
        ...
        $("#search").bind("keydown", function(event) {
            // evitemos que la caja de búsqueda pierda el foco cuando se 
            ...
            select: function(event, ui) {
                ...
                // añade un "placeholder" para luego incluir la coma y el 
                // espacio al final
                terms.push("");
    ...
    // captura y envío de los eventos del botón 'Like' de Facebook
    CT.like = function() {
